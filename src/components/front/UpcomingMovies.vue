<template>
  <div id="example">
    ...
    <carousel-3d :controls-visible="true" :clickable="false" :key="upcomingMovies.length" :listData="upcomingMovies" :height="500">
...
export default {
  ...
  methods: {
    async fetchUpcomingMovies() {
      ...
      const response = await this.$http.get(`https://api.themoviedb.org/3/movie/upcoming?api_key=${token}`);

<template>
  <div>
    <div  class="container flex flex-col md:flex-row lg:flex-row mx-auto mt-20 border-b border-gray-600 pb-2">
      ...
      <div class="ml-2 md:ml-24 lg:ml-24">
        ...
        <div class="mt-5">
          <a @click.prevent="openYouTubeModel" target="blank" class="rounded bg-yellow-500 px-5 py-3 inline-flex text-black">

<template>
  <div class="relative">
    ...
    <button @click="isOpen = false" v-if="isOpen" class="fixed top-0 right-0 botton-0 w-full h-full cursor-default bg-black opacity-50">
    ...
    <div v-if="isOpen" class="absolute bg-white py-2 rounded-lg w-48 right-0 mr-3 shadow-xl">
      ...
      <a @click.prevent="logout" class="text-gray-500 block px-4 py-2 hover:bg-indigo-500 hover:text-white">Logout</a>
    </div>
  </div>
</template>
